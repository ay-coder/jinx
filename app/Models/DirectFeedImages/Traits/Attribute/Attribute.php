<?php namespace App\Models\DirectFeedImages\Traits\Attribute;
...
use App\Repositories\DirectFeedImages\EloquentDirectFeedImagesRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentDirectFeedImagesRepository;
