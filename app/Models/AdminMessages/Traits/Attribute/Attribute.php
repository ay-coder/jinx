<?php namespace App\Models\AdminMessages\Traits\Attribute;
...
use App\Repositories\AdminMessages\EloquentAdminMessagesRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentAdminMessagesRepository;
