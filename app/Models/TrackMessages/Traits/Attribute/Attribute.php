<?php namespace App\Models\TrackMessages\Traits\Attribute;
...
use App\Repositories\TrackMessages\EloquentTrackMessagesRepository;
...
trait Attribute
{
    ...
    {
        $repository = new EloquentTrackMessagesRepository;
